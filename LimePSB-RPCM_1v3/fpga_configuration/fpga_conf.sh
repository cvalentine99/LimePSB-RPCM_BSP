...
#if [ ! -d /sys/class/gpio/gpio520 ]; then
#    echo "GPIO520 not exported, trying to export..."
#    echo 520 > /sys/class/gpio/export
#    if [ ! -d /sys/class/gpio/gpio520 ]; then
#	echo "ERROR: directory /sys/class/gpio/gpio520 does not exist"
#	exit 1
#    fi
#else
#    echo "OK: GPIO520 exported"
#fi
